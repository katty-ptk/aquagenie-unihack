...
import 'package:bluetooth_classic_example/providers/device.provider.dart'
    as _i4;
import 'package:bluetooth_classic_example/providers/user.provider.dart' as _i6;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i5.HomeScreenProvider>(_i5.HomeScreenProvider());
    gh.singleton<_i6.UserProvider>(_i6.UserProvider(gh<_i3.AuthProvider>()));
    return this;
  }
}
