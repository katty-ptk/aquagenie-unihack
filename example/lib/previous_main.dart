...
class MyPreviousApp extends StatefulWidget {
  const MyPreviousApp({super.key});

  @override
  State<MyPreviousApp> createState() => _MyPreviousAppState();
}

class _MyPreviousAppState extends State<MyPreviousApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Plugin example previous app'),
        ),
